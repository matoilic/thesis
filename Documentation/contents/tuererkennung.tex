...
\begin{figure}	
\subfloat[Kanten vor dem Joining]{\includegraphics[width=0.48\textwidth]{images/door-side-raw}}\qquad
\subfloat[Kanten nach dem Joining]{\includegraphics[width=0.48\textwidth]{images/door-side-joined}}\qquad
